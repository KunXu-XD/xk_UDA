...
if __name__ == '__main__':
    "#######——————————数据读取——————————#######"
    src, tar = 'E:\\徐锟博士\\徐锟\\科研工作\\数据\\华工数据集\\数据集\\3000_3\\Data_3000_3_FFT.mat', \
               'E:\\徐锟博士\\徐锟\\科研工作\\数据\\华工数据集\\数据集\\3500_3\\Data_3500_3_FFT.mat'
    ...
    sampler_tar = samplers.MPerClassSampler(tar_y, m=30, length_before_new_iter=len(tar_x))
    ...
    # import scipy.io as io
    #
    # io.savemat('CNN_ODA.mat', {'Fea': Fea_tar, 'label': label_real})
