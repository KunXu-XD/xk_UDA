    ...
    with torch.no_grad():
        for i, (im, label) in enumerate(test_loader):
            ...
            def outlier(each_target_share_weight):
                return each_target_share_weight < 0.1
...
if __name__ == '__main__':
    ...
    io.savemat('UAN_OPDA.mat', {'Fea': Fea_tar, 'label': tar_y})
    ...
    marker2 = ['v', 's', 'p']
    nn_cls.plot_tsne_single(label=attack_types, X=X_tsne2, y=y_tsne1, edgecolor=edgecolor2, marker=marker2,
                            title='TSNE')
